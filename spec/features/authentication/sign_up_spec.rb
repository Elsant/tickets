...
feature 'Sign Up', :devise do
  ...
  scenario 'visitor can sign up with valid email address and password' do
    sign_up_with('test@example.com', 'plainpassw', 'plainpassw')
  ...
  scenario 'visitor cannot sign up with invalid email address' do
    sign_up_with( 'Adam', 'plainpassw', 'plainpassw')
  ...
  scenario 'visitor cannot sign up without password confirmation' do
    sign_up_with('test@example.com', 'plainpassw', '')
  ...
  scenario 'visitor cannot sign up with mismatched password and confirmation' do
    sign_up_with( 'test@example.com', 'plainpassw', 'mismatch')
    expect(page).to have_content "Password confirmationdoesn't match Password"
  end
